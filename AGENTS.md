...
**Never modify source code inside a git submodule.** The upstream demo lives in [nemotron-ocr-v2](nemotron-ocr-v2) (see [.gitmodules](.gitmodules)). Treat submodule trees as read-only vendor code.
